#!/usr/bin/env python3
"""
Compute average hit@1 for MMEB V2 video evaluation.

Usage:
    python eval/tools/compute_mmeb_video_hit1_avg.py --score_dir /path/to/video-gen
"""
import argparse
import json
...
def main() -> None:
    ...
    benchmark_scores: Dict[str, float] = {}
    if args.benchmark_json is not None and args.benchmark_json.exists():
        benchmark_scores = load_benchmark_scores(args.benchmark_json)
    elif args.benchmark_json is not None:
