...
class ModelArguments:
    ...
    max_new_tokens: int = field(default=4096, metadata={"help": "Maximum number of new tokens to generate"})
...
class DataArguments:
    ...
    resize_min_pixels: int = field(default=768, metadata={"help": "The min pixels of the image to resize the image. This is only works when `--resize_use_processor true`."})
    resize_max_pixels: int = field(default=2359296, metadata={"help": "The max pixels of the image to resize the image. This is only works when `--resize_use_processor true`."})
